...
namespace Poc1.Bob.Core.Interfaces.Templates
{
	...
	public class TemplateInstance
	{
		...
		public TemplateInstance( Template template, string name, object data, string location )
		{
			m_Template = template;
			m_Name = name;
			m_Data = data;
	...
	public class TemplateInstance<T> : TemplateInstance
		where T : class
	{
		/// <summary>
		/// Setup constructor
		...
		/// <param name="data">Template instance data</param>
		/// <param name="location">Template location (if loaded from a file)</param>
		public TemplateInstance( Template template, string name, T data, string location ) :
