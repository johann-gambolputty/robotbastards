...
{
	/// <summary>
	/// A list of terrain types
	/// </summary>
	[Serializable]
	public class TerrainTypeList
	{
		/// <summary>
		...
		/// </summary>
		public static TerrainTypeList Load( string path )
		{
		...
		/// </summary>
		public static TerrainTypeList Load( Stream src, string loadPath )
		{
			...
			return ( TerrainTypeList )formatter.Deserialize( src );
		}
