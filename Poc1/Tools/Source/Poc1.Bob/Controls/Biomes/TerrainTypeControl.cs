...
{
	public partial class TerrainTypeControl : UserControl
	{
		#region Events
		...
		/// </summary>
		public event Action<TerrainTypeControl> Selected;

		/// <summary>
		/// Event raised when the underlying terrain type is modified by this control
		/// </summary>
		public event Action<TerrainTypeControl> Changed;

		/// <summary>
		/// Event raised when this control is deleted
		/// </summary>
		public event Action<TerrainTypeControl> Deleted;
