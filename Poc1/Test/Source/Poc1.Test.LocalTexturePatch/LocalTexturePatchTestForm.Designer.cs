...
{
	partial class LocalTexturePatchTestForm
	{
		/// <summary>
		...
		private void InitializeComponent( )
		{
			...
			this.display1.FocusOnMouseOver = false;
			this.display1.Location = new System.Drawing.Point( 0, 0 );
			this.display1.Name = "display1";
			this.display1.RenderInterval = 1;
			this.display1.Size = new System.Drawing.Size( 379, 406 );
			this.display1.StencilBits = ( ( byte )( 0 ) );
			this.display1.TabIndex = 0;
			// 
			// LocalTexturePatchTestForm
			// 
			this.AutoScaleDimensions = new System.Drawing.SizeF( 6F, 13F );
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			this.ClientSize = new System.Drawing.Size( 379, 406 );
			this.Controls.Add( this.display1 );
			this.Name = "LocalTexturePatchTestForm";
			this.Text = "Form1";
			this.Load += new System.EventHandler( this.LocalTexturePatchTestForm_Load );
