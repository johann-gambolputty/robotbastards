...
REM
REM Usage:
REM	BuildRenderAssemblies.bat [Configuration] [DestinationDirectory]
REM
...
REM
REM For example,
REM	BuildRenderAssemblies Debug .\Temp
...
REM msbuild rb.rendering.implementations.csproj /t:Build /p:Configuration=%1
