	...
	public class CgShaderParameterDefaultBinding : ShaderParameterBinding
	{
		...
		public override void	ApplyTo( ShaderParameter parameter )
		{
			...
			switch ( m_Binding )
			{
				...
				{
					Matrix44 modelMatrix = OpenGlRenderer.Inst.GetTransform( Transform.LocalToWorld );
				...
				{
					Matrix44 viewMatrix = OpenGlRenderer.Inst.GetTransform( Transform.WorldToView );
				...
				{
					Matrix44 itModelMatrix	= OpenGlRenderer.Inst.GetTransform( Transform.LocalToWorld );
				...
				{
					Cameras.Camera3 curCam = ( ( Cameras.Camera3 )OpenGlRenderer.Inst.Camera );
					if ( curCam != null )
					{
				...
				case ShaderParameterDefaultBinding.PointLights :
				{
					...
					int numActiveLights = OpenGlRenderer.Inst.NumActiveLights;
					int numPointLights	= 0;
					for ( int lightIndex = 0; lightIndex < numActiveLights; ++lightIndex )
					{
						PointLight curLight = OpenGlRenderer.Inst.GetLight( lightIndex ) as PointLight;
						if ( curLight != null )
						{
				...
				case ShaderParameterDefaultBinding.SpotLights :
				{
					...
					for ( int lightIndex = 0; lightIndex < numActiveLights; ++lightIndex )
					{
						SpotLight curLight = OpenGlRenderer.Inst.GetLight( lightIndex ) as SpotLight;
						if ( curLight != null )
						{
