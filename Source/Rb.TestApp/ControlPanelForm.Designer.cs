namespace Rb.TestApp
{
	partial class ControlPanelForm
	{
		...
		private void InitializeComponent( )
		{
			...
			this.browseViewerFileButton = new System.Windows.Forms.Button();
			this.viewerFileCombo = new System.Windows.Forms.ComboBox();
			...
			// groupBox2
			// 
			this.groupBox2.Controls.Add(this.browseViewerFileButton);
			this.groupBox2.Controls.Add(this.viewerFileCombo);
			...
			// 
			// browseViewerFileButton
			// 
			this.browseViewerFileButton.Image = global::Rb.TestApp.Properties.Resources.OpenFolder;
			this.browseViewerFileButton.Location = new System.Drawing.Point(317, 101);
			this.browseViewerFileButton.Name = "browseViewerFileButton";
			this.browseViewerFileButton.Size = new System.Drawing.Size(24, 23);
			this.browseViewerFileButton.TabIndex = 10;
			this.browseViewerFileButton.UseVisualStyleBackColor = true;
			this.browseViewerFileButton.Click += new System.EventHandler(this.browseViewerFileButton_Click);
			// 
			// viewerFileCombo
			// 
			this.viewerFileCombo.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.viewerFileCombo.FormattingEnabled = true;
			this.viewerFileCombo.Location = new System.Drawing.Point(69, 102);
			this.viewerFileCombo.Name = "viewerFileCombo";
			this.viewerFileCombo.Size = new System.Drawing.Size(244, 21);
			this.viewerFileCombo.TabIndex = 9;
			// 
			// label5
			// 
		...
		private System.Windows.Forms.Button browseViewerFileButton;
		private System.Windows.Forms.ComboBox viewerFileCombo;
