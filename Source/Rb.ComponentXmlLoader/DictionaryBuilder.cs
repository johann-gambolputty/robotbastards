...
{
	internal class DictionaryBuilder : BaseBuilder
	{
        /// <summary>
        /// Setup constructor
        /// </summary>
        ...
        public DictionaryBuilder( ComponentLoadParameters parameters, ErrorCollection errors, XmlReader reader, BaseBuilder parentBuilder ) :
            base( parameters, errors, reader, parentBuilder )
        {
			...
			//  is just a shorthand for <object type="System.Collections.Hashtable">)
            BuildObject = m_BuildObjects;
        }

		private readonly Hashtable m_BuildObjects = new Hashtable( );
	}
}
