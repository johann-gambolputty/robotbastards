...
namespace Rb.Core
{
	...
	public class TinyTime
	{
		...
		{
			return ( double )( curTime - startTime ) * ms_RcpFrequency;
		}
		...
		{
			return ( double )( curTime - startTime ) * ms_RcpMsFrequency;
		}
		...
		/// </summary>
		private static long			ms_StartTime	= CurrentTime;

		/// <summary>
		/// Reciprocal frequency (converts to seconds)
		/// </summary>
		private static double		ms_RcpFrequency = GetRcpFrequency( );

		/// <summary>
		/// Reciprocal frequency (converts to milliseconds)
		/// </summary>
		private static double		ms_RcpMsFrequency = GetRcpFrequency( ) * 1000.0f;
