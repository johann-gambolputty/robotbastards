namespace Poc1.PlanetBuilder
{
	partial class GroundTextureControl
	{
		...
		private void InitializeComponent()
		{
			...
			// groupBox1
			// 
			this.groupBox1.Controls.Add( this.altitudeGraphControl );
			...
			// groupBox2
			// 
			this.groupBox2.Controls.Add( this.slopeGraphControl );
		...
		private Rb.NiceControls.Graph.GraphControl altitudeGraphControl;
		private Rb.NiceControls.Graph.GraphControl slopeGraphControl;
	}
}
