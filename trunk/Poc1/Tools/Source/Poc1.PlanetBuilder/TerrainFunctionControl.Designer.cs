namespace Poc1.PlanetBuilder
{
	partial class TerrainFunctionControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.groundOffsetFunctionGroupBox.Controls.Add(this.groundOffsetEnableCheckBox);
			...
			this.groundOffsetFunctionGroupBox.Location = new System.Drawing.Point(0, 139);
			...
			this.groundOffsetFunctionGroupBox.TabIndex = 4;
			...
			this.groundOffsetEnableCheckBox.Location = new System.Drawing.Point(7, 1);
			...
			this.groundOffsetEnableCheckBox.TabIndex = 0;
			...
			this.Controls.Add(this.groundOffsetFunctionGroupBox);
