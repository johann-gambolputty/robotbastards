...
namespace Poc1.Universe.Planets.Spherical.Models
{
	...
	/// </summary>
	public class SpherePlanetProcTerrainModel : SpherePlanetEnvironmentModel, ISpherePlanetTerrainModel, IPlanetProcTerrainModel, ITerrainPatchGenerator, IPlanetTerrainPackTextureModel
	{
		/// <summary>
		...
		{
			if ( IsModelChangedUsed )
			{
				OnModelChanged( new PlanetTerrainModelChangedEventArgs( texturesChanged, geometryChanged ) );
			}
		}
