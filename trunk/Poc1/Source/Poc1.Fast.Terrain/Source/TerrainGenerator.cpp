...
namespace Poc1
{
	namespace Fast
	{
		namespace Terrain
		{
			...
			void TerrainGenerator::Setup( const float patchScale, const float minHeight, const float maxHeight )
			{
				m_pImpl->GetBaseDisplacer( ).Setup( patchScale, minHeight, maxHeight );
			}
