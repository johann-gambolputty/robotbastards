...
namespace Poc1.Core.Classes.Astronomical.Stars
{
	...
	/// Sky box rendering
	/// </summary>
	public class TexturedStarBox : IRenderable<IUniRenderContext>
	{
		#region Construction
		...
		/// </summary>
		public TexturedStarBox( ) :
			this( "Effects/Planets/texStars.cgfx", "Star Fields/Default/" )
		{
		}
		...
		public TexturedStarBox( string starEffectPath, string starTexturePath )
		{
