...
namespace Rb.Rendering.Contracts
{
	...
	public interface IDraw
	{
		...
		Draw.IBrush NewBrush( Brush brush );
		...
		/// </summary>
		Draw.ISurface NewSurface( Draw.IBrush brush, Draw.IPen pen);
		...
		/// <param name="start">Line start</param>
		/// <param name="end">Line end</param>
		void Line( Draw.IPen pen, Point2 start, Point2 end );
		...
		void Sphere( Draw.ISurface mould, Point3 centre, float radius );
		...
		void Sphere( Draw.ISurface mould, Point3 centre, float radius, int sSamples, int tSamples );
		...
		void Cylinder( Draw.ISurface mould, Point3 start, Point3 end, float radius );
		...
		void Cylinder( Draw.ISurface mould, Point3 start, Point3 end, float radius, int sSamples );
		...
		void Capsule( Draw.ISurface mould, Point3 start, Point3 end, float radius );
		...
		void Capsule( Draw.ISurface mould, Point3 start, Point3 end, float radius, int sSamples );
