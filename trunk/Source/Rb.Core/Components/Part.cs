...
{
	/// <summary>
	/// Part is a handy implementation of a bunch of component interfaces
	/// </summary>
	[Serializable]
	public class Part : Composite, IUnique, IMessageHandler, IMessageHub, ISupportsDynamicProperties
	{
